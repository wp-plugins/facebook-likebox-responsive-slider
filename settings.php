	...
	public function __construct()
	{
		...
		**/
		...
		$settings_page = '';
			...
			add_settings_field('facebook_likebox_slider-setting_appid', 'Facebook App ID', array(&$this, 'settings_field_input_text'), 'facebook_likebox_slider', 'facebook_likebox_slider-section', array('field' => 'setting_appid', 'field_value' => '', 'other' => 'MAXLENGTH="70" size="70"'));
			add_settings_field('facebook_likebox_slider-setting_fbsitename', 'Facebook Page Name (required)', array(&$this, 'settings_field_input_text'), 'facebook_likebox_slider', 'facebook_likebox_slider-section', array('field' => 'setting_fbsitename', 'field_value' => '', 'other' => 'MAXLENGTH="70" size="48" placeholder="eg.: pantherius"'));
